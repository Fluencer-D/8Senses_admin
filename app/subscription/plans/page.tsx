...
const PlansPage: React.FC = () => {
  ...
  const plansData: PlanData[] = [
    {
      ...
      name: "Free",
      price: "$0",
      benefits: "Basic access to community resources."
    },
    {
      id: 2,
      name: "Standard",
      price: "$19.99",
      benefits: "Access to webinars & select premium content."
    },
    {
      id: 3,
      name: "Premium",
      price: "$49.99",
      benefits: "Full access to courses, discounts & webinars."
    }
  ];
  ...
  const handleAddNewPlan = () => {
    ...
    // Implement add new plan functionality
  };
  ...
  return (
    <div className="p-6 max-w-[84%] mt-15 ml-70 mx-auto">
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        {/* Table Header */}
        <div className="grid grid-cols-4 py-4 px-6 bg-gray-50 text-[#1E437A] font-medium">
          <div>Plan Name</div>
        ...
        {/* Table Body */}
        {plansData.map((plan) => (
          <div key={plan.id} className="grid grid-cols-4 py-4 px-6 border-t border-gray-200 items-center">
            <div className="text-[#1E437A] font-medium">{plan.name}</div>
            <div className="text-[#1E437A]">{plan.price}</div>
            <div className="text-[#667085]">{plan.benefits}</div>
  ...
  <path fillRule="evenodd" clipRule="evenodd" d="M17.3047 6.82016C18.281 5.84385 18.281 4.26093 17.3047 3.28462L16.7155 2.69537C15.7391 1.71906 14.1562 1.71906 13.1799 2.69537L3.69097 12.1843C3.34624 12.529 3.10982 12.967 3.01082 13.4444L2.34111 16.6738C2.21932 17.261 2.73906 17.7807 3.32629 17.6589L6.55565 16.9892C7.03302 16.8902 7.47103 16.6538 7.81577 16.3091L17.3047 6.82016ZM16.1262 4.46313L15.5369 3.87388C15.2115 3.54844 14.6839 3.54844 14.3584 3.87388L13.4745 4.75779L15.2423 6.52556L16.1262 5.64165C16.4516 5.31621 16.4516 4.78857 16.1262 4.46313ZM14.0638 7.70407L12.296 5.9363L4.86948 13.3628C4.75457 13.4777 4.67577 13.6237 4.64277 13.7829L4.23082 15.7692L6.21721 15.3573C6.37634 15.3243 6.52234 15.2455 6.63726 15.1306L14.0638 7.70407Z" fill="#456696"/>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  <path d="M8.33366 8.12508C8.7939 8.12508 9.16699 8.49818 9.16699 8.95842V13.9584C9.16699 14.4187 8.7939 14.7917 8.33366 14.7917C7.87342 14.7917 7.50033 14.4187 7.50033 13.9584V8.95842C7.50033 8.49818 7.87342 8.12508 8.33366 8.12508Z" fill="#456696"/>
  <path d="M12.5003 8.95842C12.5003 8.49818 12.1272 8.12508 11.667 8.12508C11.2068 8.12508 10.8337 8.49818 10.8337 8.95842V13.9584C10.8337 14.4187 11.2068 14.7917 11.667 14.7917C12.1272 14.7917 12.5003 14.4187 12.5003 13.9584V8.95842Z" fill="#456696"/>
  <path fillRule="evenodd" clipRule="evenodd" d="M15.0003 5.00008V4.16675C15.0003 2.78604 13.881 1.66675 12.5003 1.66675H7.50033C6.11961 1.66675 5.00033 2.78604 5.00033 4.16675V5.00008H3.75033C3.29009 5.00008 2.91699 5.37318 2.91699 5.83342C2.91699 6.29365 3.29009 6.66675 3.75033 6.66675H4.16699V15.8334C4.16699 17.2141 5.28628 18.3334 6.66699 18.3334H13.3337C14.7144 18.3334 15.8337 17.2141 15.8337 15.8334V6.66675H16.2503C16.7106 6.66675 17.0837 6.29365 17.0837 5.83342C17.0837 5.37318 16.7106 5.00008 16.2503 5.00008H15.0003ZM12.5003 3.33341H7.50033C7.04009 3.33341 6.66699 3.70651 6.66699 4.16675V5.00008H13.3337V4.16675C13.3337 3.70651 12.9606 3.33341 12.5003 3.33341ZM14.167 6.66675H5.83366V15.8334C5.83366 16.2937 6.20676 16.6667 6.66699 16.6667H13.3337C13.7939 16.6667 14.167 16.2937 14.167 15.8334V6.66675Z" fill="#456696"/>
</svg>
              </button>
            </div>
          </div>
