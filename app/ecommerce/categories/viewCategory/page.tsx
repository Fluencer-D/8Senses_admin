...
const CategoryDetails = () => {
  ...
  if (loading) return <div className="p-10">Loading category details...</div>;
    ...
    <div className="p-6 max-w-[84%] mt-15 ml-70 mx-auto overflow-y-auto hide-scrollbar">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          <button onClick={handleCancel} className="px-4 py-2 border border-[#858D9D] rounded-lg text-gray-700 flex items-center gap-1">
            ✖ Cancel
          </button>
