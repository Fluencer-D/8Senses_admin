...
export default function RecipeAdminPanel() {
  ...
  const removeArrayField = (field: "ingredients" | "instructions" | "tags", index: number) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const updateArrayField = (field: "ingredients" | "instructions" | "tags", index: number, value: string) => {
    setFormData((prev) => ({
      ...prev,
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-6 text-xl font-semibold text-gray-800">Loading recipes...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-4xl font-bold text-slate-900 mb-2">Recipe Management</h1>
              <p className="text-lg text-slate-600">Manage your delicious recipe collection</p>
            </div>
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 mb-8 border border-slate-200">
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="flex-1">
                  <label className="block text-sm font-semibold text-slate-700 mb-3">Search Recipes</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              {filteredRecipes.map((recipe) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="font-bold text-xl text-slate-900 mb-3 line-clamp-2">{recipe.title}</h3>
                    <p className="text-slate-600 text-base mb-4 line-clamp-2 leading-relaxed">{recipe.description}</p>
            ...
            {filteredRecipes.length === 0 && (
              <div className="text-center py-20">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4">No recipes found</h3>
                <p className="text-lg text-slate-600">Try adjusting your search or create a new recipe.</p>
              </div>
            )}
          </div>
        )}
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-slate-800 mb-2">Recipe Title</label>
                    <input
                      type="text"
                      style={{color:"black"}}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({ ...prev, category: e.target.value as Recipe["category"] }))
                        }
                        className="w-full px-4 py-3 text-lg border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all duration-200"
                      >
                        {CATEGORIES.map((category) => (
                    ...
                    <div>
                      <label className="block text-sm font-bold text-slate-800 mb-2">Servings</label>
                      <div className="relative">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-bold text-slate-800 mb-2">Prep Time</label>
                      <div className="relative">
                    ...
                    <div>
                      <label className="block text-sm font-bold text-slate-800 mb-2">Cook Time</label>
                      <div className="relative">
                        <Clock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5" />
                        <input
                        style={{color:"black"}}
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-bold text-slate-800 mb-2">Calories</label>
                      <input
                      style={{color:"black"}}
                        type="number"
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            nutritionFacts: { ...prev.nutritionFacts, calories: Number.parseInt(e.target.value) || 0 },
                          }))
                        }
                        className="w-full px-4 py-3 text-lg border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all duration-200"
                      />
                    ...
                    <div>
                      <label className="block text-sm font-bold text-slate-800 mb-2">Protein (g)</label>
                      <input
                      style={{color:"black"}}
                        type="number"
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            nutritionFacts: { ...prev.nutritionFacts, protein: Number.parseInt(e.target.value) || 0 },
                          }))
                        }
                        className="w-full px-4 py-3 text-lg border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all duration-200"
                      />
                    ...
                    <div>
                      <label className="block text-sm font-bold text-slate-800 mb-2">Carbs (g)</label>
                      <input
                      style={{color:"black"}}
                        type="number"
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            nutritionFacts: { ...prev.nutritionFacts, carbs: Number.parseInt(e.target.value) || 0 },
                          }))
                        }
                        className="w-full px-4 py-3 text-lg border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all duration-200"
                      />
                    ...
                    <div>
                      <label className="block text-sm font-bold text-slate-800 mb-2">Fat (g)</label>
                      <input
                      style={{color:"black"}}
                        type="number"
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            nutritionFacts: { ...prev.nutritionFacts, fat: Number.parseInt(e.target.value) || 0 },
                          }))
                        }
                        className="w-full px-4 py-3 text-lg border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all duration-200"
                      />
                    ...
                    <div className="col-span-2">
                      <label className="block text-sm font-bold text-slate-800 mb-2">Fiber (g)</label>
                      <input
                      style={{color:"black"}}
                        type="number"
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            nutritionFacts: { ...prev.nutritionFacts, fiber: Number.parseInt(e.target.value) || 0 },
                          }))
                        }
                        className="w-full px-4 py-3 text-lg border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all duration-200"
                      />
              ...
              <div className="mt-12 flex justify-end gap-4">
                ...
                <button
                  type="button"
                  onClick={currentView === "create" ? createRecipe : updateRecipe}
