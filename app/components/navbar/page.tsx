    ...
    >
      ...
      <div className="flex items-center space-x-8">
        ...
        <div className="relative cursor-pointer">
          ...
          <span className="absolute -top-3 -right-3 bg-red-500 text-white text-sm font-bold rounded-full px-1.5">
            3
          </span>
        </div>
        ...
        <div className="relative cursor-pointer">
          ...
          <span className="absolute -top-2.5 -right-3 bg-red-500 text-white text-xs font-bold rounded-full px-1.5">
            64
          </span>
        </div>
